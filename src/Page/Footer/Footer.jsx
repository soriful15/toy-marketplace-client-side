        ...
        <>
            <footer className="footer p-10 bg-lime-100  text-base-content mt-10">
                <div>
                    ...
                    <p> <span className='lg:text-2xl text-blue-700'>Animal Toys KingDom</span>.<br />Providing reliable tech since 1992 <br /> Dhanmondi, Dhaka-1205 Bangladesh</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <a className="link link-hover">Latest Toy</a>
            ...
            <footer className="footer items-center p-4 bg-neutral text-neutral-content lg:px-10">
